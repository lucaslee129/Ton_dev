/**
 * Provides a Hashmap contract implementation.
 *
 * The Hashmap contract allows storing key-value pairs in a hashmap data structure.
 * It provides methods to deploy the contract, set key-value pairs, and clear old values.
 * The contract can be created from a configuration object or an existing contract address.
 */
import { Address, beginCell, Cell, Slice, Contract, contractAddress, ContractProvider, Sender, SendMode, TupleItemSlice } from '@ton/core';
